...
const gleamLanguage = language.LRLanguage.define({
  parser: parser.configure({
    props: [
      highlight.styleTags({
        Comment: highlight.tags.comment,
        "Number Decimal Hex Octal Binary Float": highlight.tags.number,
        String: highlight.tags.string,
        UppercaseIdentifier: highlight.tags.typeName,
...
function gleam(config = {}) {
  let lang = gleamLanguage;
  return new language.LanguageSupport(lang, gleamLanguage.data.of({}));
}

exports.gleam = gleam;
exports.gleamLanguage = gleamLanguage;
exports.lezerParser = lezerParser;
